#!/usr/bin/env python3
"""Run the immutable 227-vector predecessor floor without touching bound evidence."""
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="mal-fabric-demo004-regression-") as temporary:
        temp = Path(temporary)
